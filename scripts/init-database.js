#!/usr/bin/env node
// Script to initialize the database with the required schema
...
const dbConfig = {
  host: 'localhost',
  port: 3307, // Changed port to match our docker-compose.yml
  user: 'root',
  ...
  try {
    ...
    try {
      await connection.execute(
        "CREATE USER IF NOT EXISTS 'llm_user'@'%' IDENTIFIED BY 'secure_password123'"
      );
